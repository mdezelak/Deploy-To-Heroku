...
router.get('/:id', function(req, res) {
  try{
    ...
    console.log(id)
    con.query(`SELECT IdKolesa, Kolo.naziv as NazivKolesa, Opis as OpisKolesa, Slika.naziv as NazivSlike, Slika.Podatki, Kordinate.naziv as NazivKordinat, Lat, Kordinate.Longitude 
    FROM Kolo
